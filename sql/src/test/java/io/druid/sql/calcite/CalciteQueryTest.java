...
public class CalciteQueryTest
{
    ...
    testQuery(
        ...
        ImmutableList.<Query>of(
            ...
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(QSS(Filtration.eternity()))
                .filters(NOT(SELECTOR("dim1", NullHandlingHelper.useDefaultValuesForNull() ? null : "", null)))
                .columns("__time", "cnt", "dim1", "dim2", "m1", "m2", "unique_dim1")
                .resultFormat(ScanQuery.RESULT_FORMAT_COMPACTED_LIST)
                .context(QUERY_CONTEXT_DEFAULT)
                .build()
  ...
  public void testColumnIsNull() throws Exception
  {
    ...
    testQuery(
        ...
        ImmutableList.of(
            new Object[]{NullHandlingHelper.useDefaultValuesForNull() ? 3L : 2L}
        )
    );
  }
  ...
  public void testFilteredAggregations() throws Exception
  {
    testQuery(
        ...
        ImmutableList.of(
            new Object[]{1L, 5L, 1L, 3L, 5L, 5L, 2L, 1L, 5L, 1L}
        )
    );
  }
  ...
  public void testExactCountDistinct() throws Exception
  {
    ...
    testQuery(
        ...
        ImmutableList.of(
            new Object[]{NullHandlingHelper.useDefaultValuesForNull() ? 2L : 3L}
        )
    );
  }
  ...
  public void testCountDistinctOfLookup() throws Exception
  {
    ...
    testQuery(
        ...
        ImmutableList.of(
            new Object[]{NullHandlingHelper.useDefaultValuesForNull() ? 2L : 1L}
        )
    );
  }
