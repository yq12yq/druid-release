...
public class ExprMacroTest
{
  ...
  public void testTimestampCeil()
  {
    ...
    assertExpr("timestamp_ceil(t, 'P1D', null,'America/Los_Angeles')", new DateTime("2000-02-03T08").getMillis());
    assertExpr("timestamp_ceil(t, 'P1D', null,CityOfAngels)", new DateTime("2000-02-03T08").getMillis());
  ...
  public void testTimestampFloor()
  {
    ...
    assertExpr("timestamp_floor(t, 'P1D', null,'America/Los_Angeles')", new DateTime("2000-02-02T08").getMillis());
    assertExpr("timestamp_floor(t, 'P1D', null,CityOfAngels)", new DateTime("2000-02-02T08").getMillis());
